          ...
          <table class="table table-striped">
            ...
            <tr>
              ...
              <td>
                ...
                >
                <span class="fa fa-sync" title="{!! trans('dotenv-editor::views.backup_table_options_restore') !!}"></span>
              </a>
  ...
  new Vue({
    ...
    methods: {
      loadEnv: function(){
        ...
        $.getJSON("{{ url('/admin/env') }}/getdetails", function(items){
          vm.entries = items;
        });
      },
      ...
      makeBackup: function(){
        var vm = this;
        $.ajax({
          url: "{{ url('/admin/env') }}/createbackup",
          type: "get",
          success: function(){
      ...
      showBackupDetails: function(timestamp, formattedtimestamp){
        ...
        var vm = this;
        $.getJSON("{{ url('/admin/env') }}/getdetails/" + timestamp, function(items){
          vm.details = items;
      ...
      restoreBackup: function(timestamp){
        var vm = this;
        $.ajax({
          url: "{{ url('/admin/env') }}/restore/" + timestamp,
          type: "get",
          success: function(){
            vm.loadEnv();
