														...
														<div class="inside">
															<div class="customlinkdiv" id="customlinkdiv">
																...
																<p class="button-controls">
																	...
																	<a  href="#" onclick="addcustommenu()"  class="btn btn-success text-white submit-add-to-menu right"  >Add menu item</a>
											...
											<div class="menu-edit ">
												<div id="nav-menu-header">
													<div class="major-publishing-actions">
														...
														<div class="publishing-action">
															<a onclick="createnewmenu()" name="save_menu" id="save_menu_header" class="btn btn-primary text-white menu-save">Create menu</a>
														</div>
														@elseif(request()->has("menu"))
														<div class="publishing-action">
															<a onclick="getmenus()" name="save_menu" id="save_menu_header" class="btn btn-primary text-white menu-save">Save menu</a>
															...
															<li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
																...
																<div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
																	...
																	<p class="field-css-classes description description-thin">
																		<label for="edit-menu-item-classes-{{$m->id}}"> Icon (optional)
																			<br>
												...
												<div id="nav-menu-footer">
													<div class="major-publishing-actions">
														...
														@elseif(request()->has("menu"))
														<span class="delete-action"> <a class="submitdelete btn btn-danger text-white deletion menu-delete" onclick="deletemenu()" href="javascript:void(9)">Delete menu</a> </span>
														<div class="publishing-action">
