                            ...
                            <form action="{{ route('updateThemeSettings') }}" method="post" role="form">
                                ...
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control" name="theme_default_footer_title"
                                               placeholder="Footer Title" type="text"
                                               value="{{ get_settings('theme_default_footer_title') }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control" name="theme_default_footer_description"
                                               placeholder="Footer Description" type="text"
                                               value="{{ get_settings('theme_default_footer_description') }}">
                                    </div>
                                </div>
